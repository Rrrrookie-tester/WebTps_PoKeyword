...
class PlanPage(BasePage):
    ...
    @allure.step("load plan and select Ng")
    ...
    @allure.step("open add beam page")
    ...
    @allure.step("open add optimization constraint page")
